...
TESTS = [
    ...
    # ── Ford / GM ──────────────────────────────────────────────────────────
    ("Ford",   "F-150",  "Lariat",             "real_trim",    ["f-150"],                                    ["trimCodeList"],             "F-150 Lariat — trimCodeList breaks F-150 path on AT"),
    ("Ford",   "F-150",  "Raptor",             "real_trim",    ["f-150"],                                    ["trimCodeList"],             "F-150 Raptor — trimCodeList breaks F-150 path on AT"),
