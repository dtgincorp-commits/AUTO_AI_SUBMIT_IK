    ...
    if not listings:
        ...
        for i, listing in enumerate(page_listings):
            ...
            with col:
                ...
                _links_html = '<span style="color:#555;margin:0 2px">·</span>'.join(filter(None, [
                    _view_a, _dsite_a,
                ...
                _stc.html(
                    f'<div style="font-family:sans-serif;font-size:11px;padding:2px 0;display:flex;gap:3px;flex-wrap:nowrap;align-items:center;overflow:hidden;white-space:nowrap">{_links_html}</div>',
                    height=30,
                )
